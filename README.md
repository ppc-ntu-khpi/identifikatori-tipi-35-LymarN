...
В програмі є два класи: Exercise і TestResult.
В класі Exercise є метод Calculate, в якому кодується введене користувачем з клавіатури слово (ключ).
Приклад роботи програми:
      Enter text :  baby
      Hashed text: B5A3F1316FA117541B00D1FEBEEC3436
